...
// Constructor
InputLayer::InputLayer(bool sparse, bool ragged, std::string name, int dataType,
...
// Getters
bool InputLayer::getSparse() { return this->sparse; }

bool InputLayer::getRagged() { return this->ragged; }

// Setters
void InputLayer::setSparse(bool sparse) { this->sparse = sparse; }

void InputLayer::setRagged(bool ragged) { this->ragged = ragged; }
