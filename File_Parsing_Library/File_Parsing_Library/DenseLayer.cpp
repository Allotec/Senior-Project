...
// Constructor
DenseLayer::DenseLayer(std::string name, int dataType,
...
// Getters
MatrixXfRM *DenseLayer::getWeights() { return this->weights; }

MatrixXfRM *DenseLayer::getBiases() { return this->biases; }

int DenseLayer::getActivationFunction() { return this->activationFunction; }
...
bool DenseLayer::calculateOutput() {
  ...
  this->outputMatrix->push_back(dense(this->inputMatrix->at(0), *this->weights,
                                      *this->biases, this->activationFunction));
