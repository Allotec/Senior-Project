...
def modeling(train_images, train_labels, test_images, test_labels):
    ...
    model.fit(train_images, train_labels, batch_size=10, epochs=1, verbose=1)
...
def data_preproc(train_images, train_labels, test_images, test_labels):
    ...
    )  # Converting every image to 1d; train_images has a shape of 60000x28x28
    ...
    train_labels = to_categorical(
        train_labels
    )  # Converts list labels to numpy array (one-hot encoding)
...
if __name__ == "__main__":
    ...
    train_images, train_labels, test_images, test_labels = data_preproc(
    ...
    layered_view(
        model,
        to_file="Model_Images/layerView.png",
        legend=True,
        scale_xy=15,
        scale_z=10,
        max_z=100,
    ...
    plot_model(
        model,
        to_file="Model_Images/ModelSummary.png",
        show_shapes=True,
